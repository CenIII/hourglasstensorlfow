...
if __name__ == '__main__':
	...
	model_load_dir = "/home/chuancen/PJDATA/model/tiny_hourglass_9"
	...
	if training==True:
		...
		model = HourglassModel(nFeat=256, nStack=4, nLow=4, outputDim=3, batch_size=4,training=True, drop_rate=0.2, lear_rate=9*1e-5, decay=0.95, decay_step=10000,logdir_train='./logdir_train', logdir_test='./logdir_test', tiny=False, w_loss=False,modif=False)
